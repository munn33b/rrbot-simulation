...
def generate_launch_description():
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [
                    FindPackageShare("rrbot_controllers"),
                    "urdf",
                    "rrbot.urdf.xacro",
                ]
            ),
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("rrbot_bringup"), "rviz", "rrbot_namespace.rviz"]
    )
    ...
    robot_forward_position_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["forward_position_controller", "-c", "/rrbot/controller_manager", "--inactive"],
    )
